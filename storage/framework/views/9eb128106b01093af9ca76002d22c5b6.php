        ...
        <div class="login-card">
            ...
            <form method="POST" action="<?php echo e(route('login.attempt')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control" placeholder="nama@perusahaan.com" required autofocus>
                </div>
                <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\arlia\Downloads\Compressed\pengajuan-transaksi-pengeluaran\resources\views/auth/login.blade.php ENDPATH**/ ?>